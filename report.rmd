...
methylData %<>%
        mutate(Group = if_else(Slide %in% paste("X", slide_DS, sep = ""), "DS", "WT"))
head(methylData)
```
...
#methylData %<>%
 #       mutate(Infinium = if_else(Name %in% type_I$Name, "I", "II"))
